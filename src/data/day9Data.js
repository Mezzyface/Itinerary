  ...
  mandatoryActivities: [
    {
      id: "osaka-checkout",
      time: "11:00",
      title: "🏨 Osaka Capsule Hotel Checkout",
      duration: "30 minutes",
      location: "Capsule Hotel Asahi Plaza Shinsaibashi",
      status: "upcoming",
      notes: "Check out of capsule hotel, prepare for Fukuoka travel",
      confirmationCode: "HMK2TXC8PM"
    },
    {
      id: "fukuoka-checkin",
      time: "16:00",
      title: "🏠 Fukuoka House Check-in",
      duration: "30 minutes",
      location: "Hakata Ward House",
      status: "upcoming",
      notes: "Check into house in Hakata Ward, Fukuoka",
      confirmationCode: "HMMK8QPSFC"
    }
  ],
  timeBlocks: [
